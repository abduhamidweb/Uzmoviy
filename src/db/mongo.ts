...
mongoose
  .connect(process.env.MONGODB_URI as string | "mongodb+srv://abduhamidbotirovweb:abduhamidjon707@cluster0.ab9kvno.mongodb.net/codecrafters?retryWrites=true&w=majority")   
  .then(() => {
